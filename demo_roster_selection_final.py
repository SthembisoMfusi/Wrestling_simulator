...
def create_demo_rosters():
    ...
    male_names = [
        ...
        "Undertaker", "Shawn Michaels", "Triple H", "Bret Hart",
        "Randy Savage", "Ric Flair", "Roddy Piper", "Dusty Rhodes"
    ]
    
    female_names = [
        "Becky Lynch", "Charlotte Flair", "Sasha Banks", "Bayley",
        "Asuka", "Alexa Bliss", "Ronda Rousey", "Trish Stratus",
        "Lita", "Chyna", "Beth Phoenix", "Mickie James"
    ]
    ...
    rosters_to_create = [
        ...
        ("mixed_roster.pickle", "Mixed Roster", (male_names + female_names)[:6], "mixed"),
...
def demonstrate_roster_selection():
    ...
    print("="*60)
    print("Do you want to load a saved roster or create a new roster? [Create, Load]: Load")
    print("Available rosters:")
    for i, (roster_file, wrestler_count) in enumerate(roster_info, 1):
        print(f"{i}. {roster_file} ({wrestler_count} wrestlers)")
