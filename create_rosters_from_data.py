...
def main():
    ...
    rosters_to_create = [
        ...
        ("legendary_male_roster.pickle", "Legendary Male Wrestlers", male_names, "male", 8),
        ("legendary_female_roster.pickle", "Legendary Female Wrestlers", female_names, "female", 8),
        ("mixed_legends_roster.pickle", "Mixed Legendary Wrestlers", male_names + female_names, "mixed", 12),
        ("modern_male_roster.pickle", "Modern Male Wrestlers", male_names, "male", 6),
        ("modern_female_roster.pickle", "Modern Female Wrestlers", female_names, "female", 6),
        ("diverse_roster.pickle", "Diverse Wrestlers", male_names + female_names + other_names, "mixed", 10),
        ...
        ("hall_of_fame_roster.pickle", "Hall of Fame", male_names + female_names, "mixed", 16),
    ]
    ...
    for filename, description, names, gender, count in rosters_to_create:
        if len(names) < count:
            print(f"Warning: Not enough names in {description} ({len(names)} available, {count} requested)")
            count = len(names)
