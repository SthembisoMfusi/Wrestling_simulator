...
"""
    ...
    def release(
        self, version: Optional[str] = None, bump_type: Optional[str] = None
    ) -> None:
        ...
        if version:
            ...
            print(
                "Error: Must specify either --version or a bump type (--major, --minor, --patch)"
            )
            sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(
        description="Release automation for Wrestling Simulator"
    )
